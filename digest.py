...
AI_SYSTEM = (
    ...
    "1) Системные рыночные события: сильные движения цен меди/свинца/цинка, прогнозы крупных банков, решения "
    ...
    "3) Крупные производители и значимые проекты: УГМК, РМК (Русская медная компания), Норникель (в части меди), "
    ...
    "4) Не теряй ни один из трёх металлов: следи, чтобы в выпуске по возможности были представлены и медь, "
    ...
    "регуляторика, крупные международные компании, и по возможности все три металла. Не набирай выпуск из "
